...
public class ServicoProvisionadoTO {
    ...
    public ServicoProvisionadoTO() {
    }

    public ServicoProvisionadoTO(Long id, double precoTotal, Timestamp dataDeCadastro, AgendaTO agendamento, ServicoTO servico) {
        this.id = id;
